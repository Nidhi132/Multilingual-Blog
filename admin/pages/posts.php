<div class="body">
	...
	<table class="tbl-responsive">
		<tr>
			<td colspan="5">
				<a href="<?php echo SITEURL; ?>admin/home.php?page=add_post"><button class="btn-primary btn-sm"><?php echo $lang['add'] ?></button></a>
			</td>
		</tr>
		<tr>
				...
				if($count_rows>0)
				{
					while ($row=$obj->fetch_data($res)) {
						...
						<tr>
							...
							<td>
								<a href="<?php echo SITEURL; ?>admin/home.php?page=edit_post&id=<?php echo $id; ?>" class="btn-success btn-sm"><?php echo $lang['edit'] ?></a> 
