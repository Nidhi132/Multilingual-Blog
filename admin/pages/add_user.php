<div class="body">
	...
	<form method="post" action="">
		<div class="input-group">
			...
			<input class="half" type="text" name="full_name" placeholder="<?php echo $lang['Your Full Name'] ?>" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['email'] ?></span>
			<input class="half" type="email" name="email" placeholder="<?php echo $lang['Your Email'] ?>" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['username'] ?></span>
			<input class="half" type="text" name="username" placeholder="<?php echo $lang['Your Username'] ?>" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['password'] ?></span>
			<input class="half" type="password" name="password" placeholder="<?php echo $lang['Youre Secure Password'] ?>" required="true">
		</div>
