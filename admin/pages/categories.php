<div class="body">
	...
	<table class="tbl-responsive">
		<tr>
			<td colspan="5">
				<a href="<?php echo SITEURL; ?>admin/home.php?page=add_category">
				...
				if($count_rows > 0)
				{
					while ($row=$obj->fetch_data($res)) {
						...
						<tr>
							...
							<td>
								<a href="<?php echo SITEURL; ?>admin/home.php?page=edit_category&id=<?php echo $id; ?>" class="btn-success btn-sm"><?php echo $lang['edit'] ?></a>  
